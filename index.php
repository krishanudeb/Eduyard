        ...
        <div class="span6">
          <div class="widget">
            ...
            <div class="widget-content">
              ...
              <a href="teacher_register.php" class="shortcut"> <i class="shortcut-icon icon-pencil"></i><span class="shortcut-label">Teacher Register</span> </a> 
              <a href="view_teacher_list.php" class="shortcut"> <i class="shortcut-icon icon-list-ul"></i><span class="shortcut-label">Teacher Details</span> </a>
